    ...
    try {
      ...
      if (response.data.success && response.data.authorization_url) {
        ...
        if (authWindow) {
          ...
          console.log('Stored OAuth state:', response.data.state);
          console.log('Current localStorage googleOAuthState:', localStorage.getItem('googleOAuthState'));
          ...
          const checkClosed = setInterval(() => {
            if (authWindow.closed) {
              ...
              console.log('OAuth state after window closed:', localStorage.getItem('googleOAuthState'));
            }
          }, 1000);
