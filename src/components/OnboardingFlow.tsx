...
const OnboardingFlow: React.FC<OnboardingFlowProps> = ({ onComplete }) => {
  ...
  const steps = [
    ...
    { id: 2, title: 'Connect Google Ads', description: 'Link your Google Ads account' },
    { id: 3, title: 'Connect Meta Ads', description: 'Link your Meta advertising account' },
    { id: 4, title: 'Setup Complete', description: 'Start optimizing your campaigns' }
  ];
  ...
  const canProceed = () => {
    if (currentStep === 2) return connectedAccounts.google;
    if (currentStep === 3) return connectedAccounts.meta;
    return true;
  };
        ...
        return (
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Connect Your Google Ads Account</h2>
              <p className="text-gray-600">
                Securely connect your Google Ads account to enable AI-powered campaign analysis and optimization.
              </p>
            </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-center space-x-2">
                      ...
                      <span>Campaign performance data (read-only)</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span>Account structure and settings</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span>Ability to make optimization changes (with your approval)</span>
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-800 mt-1">
                    You'll be redirected to Google's secure authentication page. We never store your login credentials.
                  </p>
                </div>
              </div>
            </div>
            ...
            {connectedAccounts.google ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                ...
                <h3 className="font-semibold text-green-900">Google Ads Connected Successfully!</h3>
                <p className="text-sm text-green-700 mt-1">Found 3 active accounts with 24 campaigns</p>
              </div>
            ) : (
              <button
        ...
        return (
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Connect Your Meta Ads Account</h2>
              <p className="text-gray-600">
                Link your Meta (Facebook/Instagram) advertising account for comprehensive cross-platform optimization.
              </p>
            </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-gray-600">
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span>Ad account performance metrics</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span>Campaign and ad set data</span>
                    </li>
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                    ...
                    <li className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span>Campaign management capabilities</span>
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-medium text-blue-900">Cross-Platform Benefits</h4>
            ...
            {connectedAccounts.meta ? (
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                <CheckCircle className="w-8 h-8 text-green-600 mx-auto mb-2" />
                <h3 className="font-semibold text-green-900">Meta Ads Connected Successfully!</h3>
                <p className="text-sm text-green-700 mt-1">Found 2 ad accounts with 18 active campaigns</p>
              </div>
            ) : (
              <button
